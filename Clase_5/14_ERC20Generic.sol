...
// 1. contructos para pasar el nomber y el simbolo
...
// 8. heredar Admin y Paused
contract MiPrimerToken is ERC20Template, Admin, Paused {
    // 4. definir un construcot que inicializa el tempplate
    constructor(string memory _name, string memory _symbol)
        ERC20Template(_name, _symbol)
    {}

    // 5. exponiendo el metodo mint pero protegido
